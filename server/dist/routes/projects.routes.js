...
import { addChecklistItem, addMember, // Ekle
addResource, completeExternalInvitation, createProject, deleteChecklistItem, deleteProject, deleteResource, getMyInvitations, getProjectActivities, getProjectDetails, getProjects, inviteMember, removeMember, respondToInvitation, // Ekle
updateChecklistItem, updateProject, } from "../controllers/project.controllers.js";
...
router.post("/:id/resources", authMiddleware, upload.single("file"), addResource);
...
router.post("/invitations/external/complete", authMiddleware, // Kullanıcının önce kayıt olup giriş yapmış olması lazım
