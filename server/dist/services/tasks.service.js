...
export class TaskService {
    ...
    static async createPersonalTask(userId, data) {
    ...
    static async getTasksByDateRange(userId, start, end) {
        return await prisma.personalTask.findMany({
            where: {
                userId: userId,
                dueDate: {
    ...
    static async updatePersonalTask(taskId, userId, data) {
    ...
    // Görevi sil
    static async deletePersonalTask(taskId, userId) {
